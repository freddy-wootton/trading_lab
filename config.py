...
FAST_MA        = 10
SLOW_MA        = 30
TRADE_INTERVAL_SECONDS = 300  # 5 minutes
INTRADAY_LOOKBACK_BARS = 100  # ~8.3 hours of 5-min candles
SIGNAL_THRESHOLD = 0.002      # 0.2 % price move needed to trigger long/short
RISK_PERCENT = 0.01           # 1 % of account balance risked per trade
MAX_POSITIONS = 3             # Don't overtrade
